...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in embeddings/embeddings_pb2_grpc.py depends on'
...
def add_EmbeddingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'EncodeText': grpc.unary_unary_rpc_method_handler(
                    servicer.EncodeText,
                    request_deserializer=embeddings_dot_embeddings__pb2.TextEmbeddingRequest.FromString,
